...
| `config.service.webServer.logging.access.enabled`         | Whether to save access logs to a file                                             | `true`                                                        |
...
| `config.service.webServer.logging.app.enabled`            | Whether to save application logs to a file                                        | `true`                                                        |
